...
using UnityEngine;
    ...
    public class CUIFitZoneScript : MonoBehaviour
    {
        ...
        float CalculateFixedWidth(UICtrlBase ctrlBase, float screenWidth, float screenHeight)
        {
            ...
            {
                m_fixedWidth = (screenWidth * ctrlBase.mReferenceResolution.y / screenHeight) - (ctrlBase.mReferenceResolution.y * 2);
        ...
        {
            CalculateFixedWidth(m_ctrlBase, screenWidth, screenHeight);
