...
namespace ProjectBall.View
{
    public class SelectLevelUI : ScreenBase
    {
        ...
        public override void OnShow()
        {
            ...
            ResourcesMgr.GetInstance().LoadAsset(GameUIManager.UI_RES_PREFIX+"SelectLevel/btnLevel",InitLevels);
        }
        ...
        {
            OpenGameUIParam param = new OpenGameUIParam();
            param.LevelsDefine = levelCfg;
